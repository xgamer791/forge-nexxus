...
- **Verify without secrets:** `npx convex run generate:routing` on polished-ram-883 — expect chat model `gemini-3.8-flash`, image `gemini-3.1-flash-lite-image`, `misrouted: false`.
