...
<section id="auth-gate" class="auth-gate" aria-label="Sign in" data-hero-video="<?php echo esc_url( get_theme_file_uri( 'assets/video/forge-viking-loop.mp4' ) ); ?>" data-hero-poster="<?php echo esc_url( get_theme_file_uri( 'assets/video/forge-viking-poster.jpg' ) ); ?>"></section>
