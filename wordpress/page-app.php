<?php
/**
 * The builder: carbon copy of the GitHub docs/ app on main.
 * WordPress boots the document and enqueues the same client assets.
 */
...
<section id="site-onboarding" class="site-onboarding" aria-label="Create your website" hidden></section>
...
<button class="globe-button" type="button" aria-label="Site address and domains" data-open="address" aria-haspopup="dialog"><svg><use href="#globe"/></svg></button>
...
<button aria-disabled="true"><svg><use href="#camera"/></svg><span>Camera</span></button>
<button aria-disabled="true"><svg><use href="#photo"/></svg><span>Photos</span></button>
<button aria-disabled="true"><svg><use href="#clip"/></svg><span>Files</span><svg class="chevron"><use href="#chevron"/></svg></button>
</div></section>
...
<section class="sheet preview-unbuilt" role="dialog" aria-modal="true" aria-labelledby="preview-unbuilt-title" hidden><div class="handle"></div><header><button class="dismiss" aria-label="Close preview message"><svg><use href="#close"/></svg></button><h2 id="preview-unbuilt-title">Preview</h2></header>
...
<section class="sheet dropdown address" role="dialog" aria-modal="true" aria-labelledby="address-title" hidden><header><button class="dismiss" aria-label="Close domains"><svg><use href="#close"/></svg></button><h2 id="address-title">Address</h2></header>
...
<li><svg aria-hidden="true"><use href="#check"/></svg><span data-address-upsell-domain></span></li>
<li><svg aria-hidden="true"><use href="#check"/></svg><span>No Forge badge on your site</span></li>
</ul>
...
<div class="address-tabs" role="tablist" aria-label="Address options">
...
<button type="button" class="address-tab" role="tab" id="address-tab-custom" aria-controls="address-panel-custom" aria-selected="false" tabindex="-1" data-tab="custom">Custom domain</button>
</div>
<div class="address-card address-panel" id="address-panel-forge" role="tabpanel" aria-labelledby="address-tab-forge" data-panel="address">
<div class="address-card-head"><span class="status-chip address-state" data-address-state></span></div>
...
<div class="address-card address-panel" id="address-panel-custom" role="tabpanel" aria-labelledby="address-tab-custom" data-panel="custom" hidden>
<p class="address-empty" hidden><strong>No custom domain yet</strong><span>Add a domain you own. Forge will show the one DNS record to copy.</span></p>
