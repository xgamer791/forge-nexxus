...
<meta name="app-version" content="f2298d73ddb7c70eacdc2e303d3fa25517387c29">
...
<title>Forge Nexxus</title>
<meta name="description" content="Describe the site you want and Forge Nexxus builds it: a website builder that runs on monthly credits.">
...
<section id="auth-gate" class="auth-gate" aria-label="Sign in" data-hero-video="<?php echo esc_url( get_theme_file_uri( 'assets/video/forge-viking-fwd.mp4' ) ); ?>" data-hero-poster="<?php echo esc_url( get_theme_file_uri( 'assets/video/forge-viking-poster.jpg' ) ); ?>"></section>
