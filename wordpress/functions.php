	...
	wp_get_theme()->get( 'Version' ) . '.' . (string) max(
		array_map(
			...
			[
				...
				'assets/video/forge-viking-fwd.mp4',
				'assets/video/forge-viking-yo.mp4',
...
const FORGE_FONTS_URL = 'https://api.fontshare.com/v2/css?f[]=satoshi@400,500,700,900&display=swap';
