...
// either: its builders design from the brief and DESIGN_GOD, and every one
// of their turns says only which part of which page to write.
const WRITERS = {
  ...
  "crew.ts": "the crew's turns: which part of which page a builder writes, from the brief and DESIGN_GOD",
};
