...
- Design with intent: honor explicit brand requirements, choose a subject-specific palette and one typeface with accessible contrast and hierarchy. Choose density, spacing and corner treatment for the subject rather than applying the same generous-space, rounded-block kit to every build. On a rebuild, the supplied art direction governs these choices and the composition across the whole page; a cosmetic variation is not a rebuild.
