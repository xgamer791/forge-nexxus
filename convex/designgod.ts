...
export const DESIGN_GOD = [
  ...
  "- **Space is sized for a phone too.** Roughly 48–72px between sections rather than desktop padding, and the opening fits the first screen with its main action in view — min-height:100svh, never 100vh, if it fills the screen.",
