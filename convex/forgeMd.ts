...
The brief names what this website has to do. **Build those sections.** A site that does not do the job the member asked for is a failed build.
...
- Ask for pictures with \`forge-image:N\` markers, each carrying a \`data-forge-image\` description and a sensible \`data-forge-aspect\`. Keep any existing \`https\` or \`data:\` image URL exactly as it is.
- Never ask for text, logos or watermarks inside a picture.
