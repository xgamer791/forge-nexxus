...
This is the frontend-design skill. Treat it as **mandatory design direction** for every website you build or visually edit. **Frontend design supersedes everything else.** Do not fetch URLs. Do not skip the plan → review → build process.
