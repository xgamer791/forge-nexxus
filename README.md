...
- `plans.ts` is the catalog, modelled on Wegic's plans and credits (help.wegic.ai "Plan and Credits", wegic.ai/pricing): **Free** with 30 welcome credits and one site; **Starter** at $39.90/month or $286.80/year with 600 credits a month, 15 sites and no custom domain or extra credits; **Premium** at $69.90/month or $502.80/year with unlimited credits and sites, a custom domain and extra credits. A site build holds 40 credits, Wegic's published figure (600 ÷ 40 is its 15 sites a month); the chat, edit, image and video costs and the top-up pack prices are Forge's own until Wegic publishes theirs. A conversational reply costs 1 credit — not nothing, since it is still a provider call, but a fortieth of a build. An unlimited plan is never held against a balance, but its spends are still written to the ledger. The catalog is product configuration rather than user data, served to the client by `billing.catalog` so nothing in `docs/` carries a price.
